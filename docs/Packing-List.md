# Pack for Hunters Island/Quetico trip
...
- [ ] Mattress and pump
- [ ] Cup & spoon
- [ ] GPS. Load maps, waypoints, & routes. One set of AA batteries lasts ~2 days.
- [ ] Waterproof bog for GPS
- [ ] Waterproof bag for iPhone
- [ ] Waterproof bag for passport
- [ ] Li-ion Battery banks
- [ ] USB-A -> C adapter
- [ ] Mini USB cable for GPS
- [ ] Micro USB cable for inReach
- [ ] Short USB-C cable
- [ ] Waterproof camera & batteries
- [ ] inReach (charge and check contacts)
- [ ] Headlamp (charge)
- [ ] Lucky paddling cap
- [ ] Paddling gloves
